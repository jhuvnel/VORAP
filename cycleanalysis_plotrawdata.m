...
for iFile = 1:nFiles
    ...
    elseif contains(dataPaths{iFile}, 'Adaptation') || contains(dataPaths{iFile}, 'Nystagmus')
    ...
    eyeVelLARP_cycles = zeros(nCycles,1);
    eyeVelRALP_cycles = zeros(nCycles,1);
    eyeVelZ_cycles = zeros(nCycles,1);
    ...
    box off
    axis([0 waveformLength_ms -500 500])

...
%             end
            if isfield(handles.Segment(fs),'TripolarStim')
                ...
                if isfield(handles.Segment(fs),'MultipolarStim')  %^^^^^^^^^^^^^^^^^^^^^^^^^^^^
                    if handles.Segment(fs).ForthStim
                        handles.Segment(fs).ecomb = ['stim',num2str(handles.Segment(fs).stim),'stim',num2str(handles.Segment(fs).SecondStim),'stim',num2str(handles.Segment(fs).ThirdStim),'stim',num2str(handles.Segment(fs).ForthStim),'ref',num2str(handles.Segment(fs).refNum)];
                    elseif handles.Segment(fs).ThirdStim
                        handles.Segment(fs).ecomb = ['stim',num2str(handles.Segment(fs).stim),'stim',num2str(handles.Segment(fs).SecondStim),'stim',num2str(handles.Segment(fs).ThirdStim),'ref',num2str(handles.Segment(fs).refNum)];
                    else
                        handles.Segment(fs).ecomb = ['stim',num2str(handles.Segment(fs).stim),'stim',num2str(handles.Segment(fs).SecondStim),'ref',num2str(handles.Segment(fs).refNum)];
                    end
                else
